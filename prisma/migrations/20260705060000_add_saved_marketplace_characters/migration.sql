...
-- AddForeignKey
ALTER TABLE "SavedMarketplaceCharacter" ADD CONSTRAINT "SavedMarketplaceCharacter_characterId_fkey" FOREIGN KEY ("characterId") REFERENCES "Character"("id") ON DELETE CASCADE ON UPDATE CASCADE;
